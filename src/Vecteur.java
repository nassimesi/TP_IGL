/**
 * Classe vecteur contient des méthode pour manupiler des vecteur
 * Created by Bouguedra Adem on 12/10/2017.
 */
...
public class Vecteur {
    ...
    /**
     * claculer semultanement le min et le max d'un vecteur
     *
     * @param vect
     * @param min
     * @param max
    ...
    /**
     * c'est une formule ce forme d'une méthode qui calcule le modulo 3 d'un nombre
     * @param num
     */
    ...
    /**
     * appliquer la formule en dessu sur tous les compasante de vecteur
     *
     * @param vect
     */
